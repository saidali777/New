...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002274001011').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1484670284').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL', '-1002067093962')
...
# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', ' -1002067093962'))
...
CAPTION_BUTTON_URL = "https://t.me/saidali"
